...
const BlogTitles = () => {
    const blogCategories =['General','Technology','Business','Health','Lifestyles','Education','Travel','Food']
  ...
  return (
     ...
     <input onChange={(e)=>setInput(e.target.value)} value={input} type="text" className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300' placeholder='This is the end...' required/> 
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96'>
       ...
       {!content ? (
        <div className='flex-1 flex justify-center items-center'>
          ...
          <p>Enter a topic and click "Generate Title" to get the title</p>
          </div>
       </div>
       ) : (
